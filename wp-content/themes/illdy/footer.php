				...
				<div class="row">
					...
					<div class="col-sm-3">
						...
						<?php if( $display_copyright == 1 ): ?>
							<p class="copyright"><span data-customizer="copyright-credit"><?php //printf( '%s <a href="%s" title="%s" target="_blank">%s</a>.', __( 'Desenvolvido:', 'Renato Soares' ), esc_url( 'http://www.renatosoares.net.br' ), __( 'Illdy', 'illdy' ), __( 'Illdy', 'illdy' ) ); ?></span> <?php echo illdy_sanitize_html( $footer_copyright ); ?></p>
						<?php else: ?>
